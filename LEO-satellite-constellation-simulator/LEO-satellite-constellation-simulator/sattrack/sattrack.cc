...
int main()
{
    ...
    switch (str2int(parameterTable["execute_function"].c_str()))
    {
        ...
        case str2int("simulateSatFailStatistics"):
            ...
            break; 
        case str2int("printStationShortestPath"):
            InfoProcessing::printStationShortestPath(satCountPerOrbit, totalSatCount, satellites, parameterTable);
            break;       
        case str2int("printStationHopcountPath"):
            InfoProcessing::printStationHopcountPath(satCountPerOrbit, totalSatCount, satellites, parameterTable);
            break;
        case str2int("printStationCoverSats"):
            InfoProcessing::printStationCoverSats( satellites, parameterTable);
            break;    
        default:
